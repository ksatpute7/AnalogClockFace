      ...
      if (state) {
		...
		if (key=="gridSeparator")
		    $('#gridSeparator').html(value);
                  ...
                  if (key == "userAnswerOrder") {
		    userAnswerOrder = value;
		  }
                  if (key=="userAnswer") {
                        userAnswer = value;
                  }
...
function solveEquationFunction() {
	...
	{
	    if (userAnswer[userAnswerOrder[order]].left!="" && userAnswer[userAnswerOrder[order]].right!="") {
	    updateEq.push('('+(userAnswer[userAnswerOrder[order]].left+' X '+userAnswer[userAnswerOrder[order]].right)+')')
	    }
	}

;(function(){
  ...
  $('body').prepend("<button id='fake-reset-button' style='position:absolute;bottom:20px;left:100px;z-index:6666;'>Reset</button>");
  ...
  $('body').prepend("<button id='fake-done-button' style='position:absolute;bottom:20px;left:200px;z-index:6666;'>Done</button>");

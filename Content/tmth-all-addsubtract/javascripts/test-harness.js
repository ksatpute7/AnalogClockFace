;(function(){
 ...
 /* setInterval(function(){
  ...
  $('body').prepend("<button id='fake-reset-button' style='position:absolute;bottom:20px;left:100px;z-index:999999;'>Reset</button>");
  ...
  $('body').prepend("<button id='fake-done-button' style='position:absolute;bottom:20px;left:200px;z-index:999999;'>Done</button>");
